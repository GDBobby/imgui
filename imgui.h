...
struct ImGuiDragDropContext;        // Drag Drop Context, separated from ImGuiContext
...
#define ImTextureID_Invalid     ((ImTextureID)UINT64_MAX)
#endif
...
#endif
    ImTextureRef(EWE::TextureIndex texIndex) {_TexID = texIndex;}
...
namespace ImGui
{
    ...
    IMGUI_API ImGuiDragDropContext* CreateDragDropContext();
    IMGUI_API void DestroyDragDropContext();
    IMGUI_API ImGuiDragDropContext* GetCurrentDragDropContext();
    IMGUI_API void          SetCurrentDragDropContext(ImGuiDragDropContext* ctx);
    ...
    IMGUI_API void          NewFrameDD();
    IMGUI_API void          EndFrameDD();
    ...
    IMGUI_API bool          BeginMenuBar(uint8_t row_count = 1);                                                     // append to menu-bar of current window (requires ImGuiWindowFlags_MenuBar flag set on parent window).
    IMGUI_API void          EndMenuBar();                                                       // only call EndMenuBar() if BeginMenuBar() returns true!
    IMGUI_API bool          BeginMainMenuBar(uint8_t row_count = 1);                            // create and append to a full screen menu-bar.
